...
public class ProductDAOImpl implements IProductDAO {
	...
	public PageResult query(ProductQueryObject qo) {
		...
		listData = JdbcTemplate.qurey(resultSql, new ProductResultHandle(), qo.getParameters().toArray());
	...
	public Product getProductByName(String productName) {
		...
		List<Product> list = JdbcTemplate.qurey(sql, new ProductResultHandle(), productName);
